        ...
        <section className='py-20 relative'>
            <div className="container mx-auto px-10">
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <Card imageUrl={HotelImg3} tickets={2} rating={4} price={75} />
                    <Card imageUrl={HotelImg4} tickets={12} rating={5} price={10} />
                    <Card imageUrl={HotelImg1} tickets={5} rating={4} price={15} />
